...
# def test_case():
#         test.assert_equals(frog_contest(5), "Chris ate 15 flies, Tom ate 28 flies and Cat ate 946 flies")
#         test.assert_equals(frog_contest(8), "Chris ate 36 flies, Tom ate 171 flies and Cat ate 21528 flies")
#     @test.it("Testing for 0")
# def test_zero():
#         test.assert_equals(frog_contest(0), "Chris ate 0 flies, Tom ate 0 flies and Cat ate 0 flies")
        
def frog_contest(flies):
    chris = 0
    tom = 0
    cat = 0
    for ch in range(1, flies + 1):
        chris += ch
    for t in range(1, (chris // 2) + 1):
        tom += t
    for c in range(1, (chris + tom) + 1):
        cat += c
